...
export const gateLabels: Record<string, string> = {
  ...
  missing_short_description: "Descrição curta ausente",
  invalid_image_url: "Imagem HTTPS ausente ou inválida",
  missing_image_alt: "Texto alternativo ausente",
  inactive_category: "Categoria inativa",
  inactive_marketplace: "Marketplace inativo",
  never_verified: "Produto ainda não verificado",
  missing_active_affiliate_link: "Link afiliado ativo e compatível ausente",
  reconciliation_material_mismatch: "Divergência material de identidade do produto",
  reconciliation_inconclusive: "Reconciliação inconclusiva (evidências insuficientes)",
  destination_unavailable: "Destino do link indisponível",
};
