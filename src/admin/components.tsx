...
export function AdminNav() { return <nav className="admin-nav" aria-label="Administração"><Link href="/admin">Visão geral</Link><Link href="/admin/analytics">Analytics</Link><Link href="/admin/products">Produtos</Link><Link href="/admin/taxonomy">Categorias e tags</Link><Link href="/admin/marketplaces">Marketplaces</Link></nav>; }
